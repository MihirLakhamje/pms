    ...
    <div
        ...
        <div class="relative flex items-center justify-center px-4 sm:px-6 lg:px-8">
            <div
                ...
                <div class="space-y-4">
                    <form class="mb-4 space-y-4" method="POST" action="{{ route('login.submit') }}">
                        @csrf   
                        <div>
                        ...
                        <div class="flex items-center justify-between gap-y-2">
                            <a href="{{ route('password.request') }}" class="link link-animated link-primary font-normal">Forgot Password?</a>
                        </div>
                        <button class="btn btn-lg btn-primary btn-gradient btn-block">Continue</button>
                    </form>
                </div>
            </div>
        </div>
